...
%
% SeNSE Laboratory of Dr. Mitra Hartmann
% -------------------------------------------------------------------------
% OVERVIEW:
...
%       .m - moment at the base [N-m]
%       .fs - applied force and radial distance [(N) (m)]
%       .dk0 = change in curvature at the base [1/m]
...
%       e.g. rigid boundary condition
%   {3} Deflection point (a,b) has a positive x-value
%   {4} The applied force is normal to the whisker surface
...
gama = atan2(-(y2(end)-y2(end-1)),(x2(end)-x2(end-1))); % [rad]
